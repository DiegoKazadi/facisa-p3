	...
	public static void main(String[] args) {
		...
		do {
			...
			case 2:
				...
				nome = JOptionPane.showInputDialog("Digite o nome do cliente que será excluido");
			...
			case 3:
				...
				for (Cliente cliente : clientes) {
					nomeDosClientesCadastrados += "\n Cliente:" + cliente.getNome() + " Cpf:" + cliente.getCpf() + "Código: " + cliente.getCodigoCliente();
				}
			...
			case 5:
				...
				nome = JOptionPane.showInputDialog("Digite o nome do Funcionario que será excluido");
			...
			case 6:
				...
				String nomeDosFuncionariosDaLoja = "";
				
				for (Funcionario funcionario : funcionarios) {
					nomeDosFuncionariosDaLoja += "\n Funcionario:" + funcionario.getNome() + "\n Salario:" + funcionario.getSalario() + "\n";
				}
				
				JOptionPane.showMessageDialog(null, "Lista de Funcionario: \n" + nomeDosFuncionariosDaLoja);
